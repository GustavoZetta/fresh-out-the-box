...
GameObject::GameObject() : staticSprite(nullptr), animatedSprite(nullptr), textureAtlas(nullptr), color(glm::vec4(1.0f)), position(glm::vec2(0.0f)), size(glm::vec2(0.0f)), rotation(0.0f), zIndex(0) {}
